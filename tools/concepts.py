...
PATHS = [
    ...
    {
        "id": "web-inyecciones-y-autorizacion-ruta",
        "title": "Web: inyecciones y autorizacion",
        "summary": "Las familias de bug web mas comunes fuera de LFI/SQLi: SSTI, SSRF, XXE, IDOR/BOLA, XSS, upload y command injection.",
        "concepts": ["ssti", "ssrf", "xxe", "idor-bola", "xss", "file-upload", "command-injection"],
    },
    {
        "id": "shells-y-acceso",
